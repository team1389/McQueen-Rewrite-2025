...
//     private final SparkClosedLoopController bottomPidController;
//     private final SparkClosedLoopController topPidController;
...
//         bottomPidController = shootBottomController.getClosedLoopController();
        
//         ClosedLoopConfig bottomPidConfig = new ClosedLoopConfig();

//         bottomPidConfig.feedbackSensor(FeedbackSensor.kPrimaryEncoder); // Explicitly set to integrated encoder
//         bottomPidConfig.p(ShooterConstants.kBottom_P);
//         bottomPidConfig.i(ShooterConstants.kBottom_I);
//         bottomPidConfig.d(ShooterConstants.kBottom_D);
//         // bottomPidConfig.setFF(ShooterConstants.kBottom_FF);
//         bottomPidConfig.outputRange(ShooterConstants.kBottom_MIN_OUTPUT, ShooterConstants.kBottom_MAX_OUTPUT);
//         bottomPidController.configure(bottomPidConfig);
...
//         setpoint = desiredRPM;
//         topPidController.setReference(desiredRPM, SparkMax.ControlType.kVelocity);
